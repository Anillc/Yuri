  ...
  Vec::from([
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        hart.fregs.set(rd, a.fused_mul_add(b, c, rm).to_bits());
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let b = F64::from_bits(hart.fregs[rs2]);
        let c = F64::from_bits(hart.fregs[rs3]);
        hart.fregs.set(rd, a.fused_mul_add(b, c.neg(), rm).to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let b = F64::from_bits(hart.fregs[rs2]);
        let c = F64::from_bits(hart.fregs[rs3]);
        hart.fregs.set(rd, a.fused_mul_add(b, c.neg(), rm).neg().to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let b = F64::from_bits(hart.fregs[rs2]);
        let c = F64::from_bits(hart.fregs[rs3]);
        hart.fregs.set(rd, a.neg().fused_mul_add(b, c.neg(), rm).to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let a = F64::from_bits(hart.fregs[rs1]);
        let b = F64::from_bits(hart.fregs[rs2]);
        hart.fregs.set(rd, a.add(b, rm).to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let a = F64::from_bits(hart.fregs[rs1]);
        let b = F64::from_bits(hart.fregs[rs2]);
        hart.fregs.set(rd, a.sub(b, rm).to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let a = F64::from_bits(hart.fregs[rs1]);
        let b = F64::from_bits(hart.fregs[rs2]);
        hart.fregs.set(rd, a.mul(b, rm).to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let a = F64::from_bits(hart.fregs[rs1]);
        let b = F64::from_bits(hart.fregs[rs2]);
        hart.fregs.set(rd, a.div(b, rm).to_bits());
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        hart.fregs.set(rd, num.sqrt(rm).to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let rm = round_mode(rm, hart)?;
        let num = F64::from_bits(hart.fregs[rs1]);
        hart.fregs.set(rd, num.to_f32(rm).to_bits() as u64 | NANBOX);
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        hart.fregs.set(rd, num.to_f64(rm).to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let flags = FloatFlags::new();
        let rm = round_mode(rm, hart)?;
        let num = F64::from_i32(hart.regs[rs1] as i32, rm);
        hart.fregs.set(rd, num.to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let flags = FloatFlags::new();
        let rm = round_mode(rm, hart)?;
        let num = F64::from_u32(hart.regs[rs1] as u32, rm);
        hart.fregs.set(rd, num.to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let rm = round_mode(rm, hart)?;
        let num = F64::from_bits(hart.fregs[rs1]);
        hart.regs.set(rd, num.to_u64(rm, true));
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let flags = FloatFlags::new();
        let rm = round_mode(rm, hart)?;
        let num = F64::from_i64(hart.regs[rs1] as i64, rm);
        hart.fregs.set(rd, num.to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
    ...
    Instructor {
      ...
      run: |inst, _len, _mmu, hart| {
        ...
        let flags = FloatFlags::new();
        let rm = round_mode(rm, hart)?;
        let num = F64::from_u64(hart.regs[rs1], rm);
        hart.fregs.set(rd, num.to_bits());
        flags.write(&mut hart.csr, false);
        Ok(())
      },
